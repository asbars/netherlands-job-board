  ...
  return (
    ...
    >
      <html lang="en" suppressHydrationWarning>
        <body className={`${dmSans.variable} ${dmSans.className} ${bricolage.variable} ${fraunces.variable} ${playfair.variable} ${dmSerif.variable} ${instrumentSerif.variable} ${sourceSerif.variable}`}>
          <ThemeProvider
            attribute="class"
            defaultTheme="light"
            enableSystem={false}
