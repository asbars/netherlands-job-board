/**
 * Manual Initial Job Population Script (using Apify SDK)
 * 
...
async function fetchJobsFromApify(): Promise<any[]> {
  ...
  try {
    ...
    console.log(`✅ Retrieved ${items.length} jobs from Apify\n`);
    ...
    if (error.message?.includes('not found') || error.statusCode === 404) {
      ...
      console.error('\n📋 Possible solutions:');
      console.error('   1. Subscribe to the actor at: https://apify.com/fantastic-jobs/career-site-job-listing-api');
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════');
  console.log('  Netherlands Job Board - Initial Population Script (SDK)');
  console.log('═══════════════════════════════════════════════════════════\n');
