-- ========================================
-- V15: Add missing TEXT[] array fields (ai_employment_type, ai_education_requirements)
-- ========================================
-- BUG FIX: ai_employment_type and ai_education_requirements are TEXT[] arrays but were missing
--          from v_text_array_fields list, causing "contains" operator to fail with
--          "operator does not exist: text[] ~~* unknown" error
...
DECLARE
  ...
  v_text_array_fields text[] := ARRAY['employment_type', 'ai_employment_type', 'ai_benefits', 'ai_key_skills', 'ai_keywords', 'ai_taxonomies_a', 'ai_job_language', 'ai_education_requirements'];
