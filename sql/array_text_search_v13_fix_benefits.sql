-- ========================================
-- V13: Fix Benefits filter - separate TEXT[] from JSONB arrays
-- ========================================
-- BUG FIX: ai_benefits, ai_key_skills, ai_keywords, ai_taxonomies_a, ai_job_language
--          are TEXT[] (not JSONB), so they need && operator (not ?| operator)
--          cities_derived and regions_derived are JSONB arrays and use ?| operator
...
DECLARE
  ...
  v_text_array_fields text[] := ARRAY['employment_type', 'ai_benefits', 'ai_key_skills', 'ai_keywords', 'ai_taxonomies_a', 'ai_job_language'];
