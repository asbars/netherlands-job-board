-- ========================================
-- FIXED VERSION: Handle empty Work Arrangement as Hybrid/On-site
-- ========================================
...
-- ========================================
-- TEST: Test query with Hybrid filter
-- ========================================
-- This should return jobs with ai_work_arrangement = 'Hybrid' OR ai_work_arrangement IS NULL
SELECT * FROM public.search_jobs_with_filters(
  '[{"field":"ai_work_arrangement","operator":"is_any_of","value":["Hybrid"],"is_array_value":true}]'::jsonb,
  1,
  5
);
