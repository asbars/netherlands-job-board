-- ========================================
-- V14: Fix "contains" operator for TEXT[] arrays (Benefits filter bug)
-- ========================================
-- BUG FIX: "contains" operator was calling array_contains_text_jsonb() for TEXT[] arrays
--          which only works with JSONB. Need separate helper for TEXT[] arrays.
...
-- NEW: Helper function for TEXT[] array text search
